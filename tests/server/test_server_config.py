...
class TestServerConfig:
    ...
    def test_load_config_agentuity_yaml(self, tmp_path):
        ...
        agent_file.write_text("def run(request, response, context):\n    return response.text('Hello')")
    ...
    def test_load_agents_success(self, tmp_path):
        ...
        with patch("agentuity.server.load_agent_module") as mock_load_agent_module, \
    ...
    def test_load_agents_file_not_found(self):
        ...
        with patch("agentuity.server.logger.error") as mock_logger_error, \
    ...
    def test_load_agents_json_error(self):
        ...
        with patch("agentuity.server.load_agent_module") as mock_load_agent_module, \
            ...
            mock_load_agent_module.side_effect = json.JSONDecodeError("Invalid JSON", "", 0)
    ...
    def test_autostart(self):
        ...
        with patch("agentuity.server.asyncio.new_event_loop") as mock_new_event_loop, \
